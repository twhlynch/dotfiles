...
set({ "n" }, "<leader>bf", blame.show_blame, desc("Show file blame"))
set({ "n" }, "<leader>i", reminder.ignore_buffer, desc("Toggle ignoring format reminder for buffer"))
set({ "n" }, "<leader>I", reminder.toggle, desc("Toggle format reminder"))
